...
public class ReportServiceImpl implements ReportService {
	...
	public Map<String, List<?>> getQueryReportData() {
		...
		List<String> header = Arrays.asList("area#ସ୍ଥାନ ", "awareness#ସଚେତନତା","fieldSupport#କ୍ଷେତ୍ରରେ ସହାୟତା ", "essentials#ଅତ୍ୟାବଶକୀୟ ସେବା", "health#ସ୍ୱାସ୍ଥ୍ୟ ", "reliefCampMgmt#ରିଲିଫ କ୍ୟାମ୍ପ ପରିଚାଳନା ");
...
//		} 
	...
	private ResponseEntity<String> generateQueryBasedExcel(int formId, List<SubmissionData> filteredSubmissions,Map<String,List<String>> qstMap) throws IOException, ParseException {
