...
public class ReportController {
	...
	@PostMapping("/filterOrganizations")
	public ResponseEntity<String> filterOrganizations(@RequestBody FilterParams params)  throws Exception{
		return reportService.getFilteredOrganizations(params);
	}
}
